...
export default function PostForoForm({ route, navigation: { goBack } }) {
    ...
    async function subirDatos(){
        ...
        Alert.alert("¡Enhorabuena!","Su publicación ha sido realizada con éxito.");
        goBack(); 
    }
    ...
    return (
        <View style={{flex:1, marginTop:Constants.statusBarHeight}}>
            ...
            {!loading && 
                <View style={[{backgroundColor:'#F0B27A', marginLeft:30, marginRight:30, marginTop:20, borderRadius:20, flex:1, borderBottomRightRadius:50, borderBottomLeftRadius:50}, modoNocturno ? null : {backgroundColor:'#323639', borderWidth:1}]}>
                                ...
                                <View style={{justifyContent:'center', alignItems:'center', marginBottom:15}}>
                                    <TouchableOpacity style={{backgroundColor:'#3a99d8', padding:15, borderRadius:6}} onPress={handleSubmit( ()=>{
                                        Alert.alert('¡Atención!', '¿Estás seguro que los datos introducidos son correctos?', [
                                            ...
                                            {text: 'Si', onPress: () =>  subirDatos(getValues("nombre"), getValues("informacion"), getValues("tema"))},
                                        ])
                                    })}
                                    >
